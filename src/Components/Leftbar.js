    ...
    <div className="bg-blue-700 bg-opacity-30 w-[28%] h-[550px] space-y-6 py-6 flex justify-center flex-col items-center relative mt-12 ml-14">
        ...
        <div className="flex justify-center flex-col items-center space-y-3 detail-section">
          ...
          <div className="flex rounded-lg px-2 py-1 space-x-2 bg-black opacity-70 text-white justify-between w-auto">
            <a href="https://github.com/SunnyMaurya63"><img className="h-5 w-5" src={Github} alt="github" /></a>
            <a href="https://www.linkedin.com/in/sunnymaurya6327/"><img className="h-5 w-5" src={LinkedIN} alt="LinkedIN" /></a>
            <a href="https://leetcode.com/sunnymaurya101/"><img className="h-5 w-5" src={Leetcode} alt="Leetcode" /></a>
            <a href="hhttps://codeforces.com/profile/sunnymaurya101"><img className="h-5 w-5" src={cf1} alt="cf1" /></a>
          </div>
          <div className="text-1xl font-semibold">
            +91 9610583077
          </div>
          <div className="text-1xl font-semibold">
            sunnymaurya101@gmail.com
          </div>
        </div>
        {/* CV Button division  */}
        <div>
